...
$.getJSON("http://localhost/Code-For-Revision/PHP-MYSQL-PDO-API/REST_API/product/read_one.php?id=" + id, function(data){
...
$.getJSON("http://localhost/Code-For-Revision/PHP-MYSQL-PDO-API/REST_API/category/read.php", function(data){
...
$.ajax({
    url: "http://localhost/Code-For-Revision/PHP-MYSQL-PDO-API/REST_API/product/update.php",
    type : "POST",
